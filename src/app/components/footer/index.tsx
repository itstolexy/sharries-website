    ...
    return (
        <footer className="flex flex-row">
            <div>
                ...
                <div className="flex mt-[100px] mb-[137px]">
                    ...
                    <span className="ml-[234px]">
                        ...
                        <p className="font-normal text-lg mt-8">You can <span className="underline text-[#4EAB35]">email</span></p>
                    ...
                    <span className="ml-[231px] max-w-[280px]">
                        ...
                        <p className="font-normal text-lg mt-8"><span className="underline text-[#4EAB35]">Sign Up
                        </span> for Sharrie’s signature emails and receive latest news including exclusive offers</p>
                ...
                <div className="mt-4">
                    <span className="flex flex-row">
                        <p className="ml-[80px] text-sm font-normal">&copy; sharrie’s signature 2020</p>
                    ...
                    <h2 className="flex text-[#4EAB35] text-2xl font-normal justify-center mt-6 mb-[58px]">
                        Sharrie’s Signature
                    </h2>
                </div>
            </div>
